...
<!--Header-part-->
<div id="header">
  <h1><a href="daftar.php">Putri Bengawan Solo</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">&nbsp;- Selamat Datang di Putri Bengawan Solo -</span><b class="caret"></b></a>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>&nbsp;Daftar</a>
  <ul>
    <li class="active"><a href="daftar.php"><i class="icon icon-book"></i> <span>Registrasi</span></a> </li>
  </ul>
</div>
...
<div id="content-header">
  <div id="breadcrumb">
    ...
    <a href="daftar.php" class="current">Registrasi</a>
  </div>
</div>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> &copy; Copyright <?php echo date('Y'); ?>  by.Putri Bengawan Solo</> </div>
</div>
<!--end-Footer-part--> 
